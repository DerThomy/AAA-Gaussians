...
class SplattingSettings():
    ...
    def __init__(self, parser, render=False):
        ...
        self.group_settings.add_argument("--eval_3D", type=bool_, choices=[True, False], help='Evaluate Gaussians in 3D as proposed by Hahlbohm et al. ("Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency")')
